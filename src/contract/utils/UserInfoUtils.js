  ...
  return new Promise((resolve, reject) => {
    getTX()
      .then(tx => {
        console.log(tx);
        txListener(
          getContract().methods.initPlayer(name, sex, icon, synopsis),
          tx,
          resolve,
          reject
        );
...
export const getPlayerMsgSize = address => {
  return new Promise((resolve, reject) => {
    getContract()
      .methods.getPlayerMsgSize(address)
      .call()
      .then(res => {
        resolve(res);
      })
...
export const getPlayerMsg = index => {
  return new Promise((resolve, reject) => {
    getContract()
      .methods.getPlayerMsg(index, window.neuron.getAccount())
      .call()
      .then(res => {
        resolve(res);
      })
...
export const getFavoriteSize = () => {
  return new Promise((resolve, reject) => {
    getContract()
      .methods.getFavoriteSize(window.neuron.getAccount())
...
export const getFavorite = index => {
  return new Promise((resolve, reject) => {
    getContract()
      .methods.getFavorite(index, window.neuron.getAccount())
      .call()
      .then(res => {
        resolve(res);
      })
...
export const getBalance = address => {
  return new Promise(resolve => {
    resolve(appchain.base.getBalance(address));
  });
};
